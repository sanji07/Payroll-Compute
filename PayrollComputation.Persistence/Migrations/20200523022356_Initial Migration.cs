        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TFN = table.Column<int>(maxLength: 10, nullable: false),
                    paymentMethod = table.Column<int>(nullable: false),
                    studentLoan = table.Column<int>(nullable: false),
                    Address = table.Column<string>(maxLength: 150, nullable: false),
                    City = table.Column<string>(maxLength: 3, nullable: false),
                    POcode = table.Column<string>(maxLength: 4, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeDets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeDetId = table.Column<int>(nullable: true),
                    ...
                    HoursWoreked = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ContrctHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OvertimeHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Contrctearning = table.Column<decimal>(type: "money", nullable: false),
                    Overtimeearning = table.Column<decimal>(type: "money", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_EmployeeDets_EmployeeDetId",
                        column: x => x.EmployeeDetId,
                        principalTable: "EmployeeDets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_EmployeeDetId",
                table: "PaymentRecords",
                column: "EmployeeDetId");
